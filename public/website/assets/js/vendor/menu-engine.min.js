...
//     if (o && (n = o), null != n) {
//         let e = n.nextElementSibling;
//         e.classList.contains("dropdown-menu") && (n.classList.remove("show"),
...
//     if (document.querySelectorAll(".dropdown-menu").forEach((function (e) {
...
//         el_fixed && window.addEventListener("scroll", (function () {
//             jQuery(".navbar .navbar-brand .logo").length,
//                 window.scrollY > 150 ? el_fixed.classList.add("fixed-top") : el_fixed.classList.remove("fixed-top")
//         })),
//         el_autohide = document.querySelector(".navbar"), el_autohide) {
...
// })), jQuery(window).scroll((function () { null !== document.querySelector(".navbar-collapse") && jQuery(".navbar-collapse").collapse("hide") })), jQuery(document).ready((function () { if (jQuery(window).width() <= 768) { var e = jQuery(".navbar .navbar-brand .logo").data("logo-mobile"); jQuery(".navbar .navbar-brand .logo").attr("src", e) } }));
